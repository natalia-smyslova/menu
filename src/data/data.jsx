const data = {
    Home: {
        ...
        description: (<p className="article__paragraph">Гоночное такси – отличная возможность насладиться скоростью и мастерством гонщика,
        ...
        гоночной трассе России.</p>),
    },
    Drift: {
        title: 'Дрифт-такси',
        description: (<><p className="article__paragraph"> Только на Сочи Автодроме вас ждет уникальная возможность
    ...
    Forza: {
        ...
        description: (<> <p className="article__paragraph">
